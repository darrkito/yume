...
export const UI: Record<Lang, Record<string, string>> = {
  es: {
    ...
    galleryCtaTitle: "¿Quieres unos así?",
    galleryCtaBody: "Mándanos tu diseño, personaje, mascota o logo y te preparamos una prueba digital antes de imprimir.",
    galleryCtaButton: "Pide tus stickers",
    ...
    payWithMercadoPago: "Ir al sitio de Mercado Pago",
    mpDescription: "Te llevamos al sitio seguro de Mercado Pago para pagar con tarjeta, tu cuenta o efectivo en tiendas como OXXO.",
    redirecting: "Redirigiendo…",
    continueArrow: "Continuar →",
    payHere: "Pagar aquí, sin salir de esta página",
    payHereDescription: "Ingresa tu tarjeta o genera una ficha para pagar en efectivo, todo en esta misma página.",
    includesStorePayment: "No sales del sitio de Yume",
    ...
    shippingEstimate: "Envío nacional $190 MXN (gratis desde $750) · Producción 3-5 días + envío 2-5 días",
  ...
  en: {
    ...
    galleryCtaTitle: "Want some like these?",
    galleryCtaBody: "Send us your design, character, pet, or logo and we'll prepare a digital proof before printing.",
    galleryCtaButton: "Order your stickers",
    ...
    payWithMercadoPago: "Go to Mercado Pago's site",
    mpDescription: "We'll take you to Mercado Pago's secure site to pay by card, your account, or cash at stores like OXXO.",
    redirecting: "Redirecting…",
    continueArrow: "Continue →",
    payHere: "Pay here, without leaving this page",
    payHereDescription: "Enter your card or generate a cash-payment voucher, all on this same page.",
    includesStorePayment: "Stays on Yume's site",
    ...
    shippingEstimate: "Nationwide shipping $190 MXN (free from $750) · Production 3-5 days + shipping 2-5 days",

...
export const UI: Record<Lang, Record<string, string>> = {
  es: {
    ...
    keepShopping: "Seguir viendo",
    cartSubtotalShort: "Subtotal",
    viewShop: "Ver tienda",
    from: "Desde ",
    total: "Total",
    each: "MXN c/u",
    ...
    shippingLabel: "Envío",
    freeShipping: "Gratis",
    deliveryChoice: "¿Cómo lo recibes?",
    pickupGdl: "Recoger en Guadalajara (Casa Blanca)",
    totalNote: "En el siguiente paso eliges sucursal o capturas tu dirección.",
    ...
    securePayment: "Pago seguro con Mercado Pago: tarjeta, OXXO o SPEI.",

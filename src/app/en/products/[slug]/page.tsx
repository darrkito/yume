  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-16 sm:py-24">
      ...
      <div className="grid gap-14 sm:grid-cols-2 sm:items-start">
        ...
        <div>
          <p className="mono-label animate-fade-up text-xs text-brand">{t.category}</p>
          <h1 className="animate-fade-up animate-fade-up-1 mt-3 font-display text-3xl font-black uppercase text-ink sm:text-4xl">{t.name}</h1>
      ...
      <div className="mt-20 border-t-2 border-line-strong pt-14">
        <h2 className="font-display text-2xl font-bold uppercase text-ink">Frequently Asked Questions</h2>
